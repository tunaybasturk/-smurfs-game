 ...
 * @author PC
 */
public class Kaybetme extends javax.swing.JFrame {

    /**
     * Creates new form Kaybetme
     */
    public Kaybetme() {
        initComponents();
        setSize(1920, 1080);
    ...
    private void initComponents() {
        ...
        Cikis.setBackground(new java.awt.Color(153, 204, 255));
        Cikis.setFont(new java.awt.Font("Tahoma", 0, 60)); // NOI18N
        ...
        Cikis.setBounds(780, 300, 350, 80);
        Cikis.getAccessibleContext().setAccessibleDescription("");

        ArkaPlan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/KAYBETME.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kaybetme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
